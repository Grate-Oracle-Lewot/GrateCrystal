...
ENDM
	...
	const anim_updateactorpic_command ; $e7
anim_updateactorpic: MACRO
	db anim_updateactorpic_command
ENDM

	const anim_minimize_command ; $e8
anim_minimize: MACRO
...
ENDM
	...
	const anim_bgp_command ; $ee
anim_bgp: MACRO
	db anim_bgp_command
	db \1 ; colors
ENDM

	const anim_obp0_command ; $ef
anim_obp0: MACRO
	db anim_obp0_command
	db \1 ; colors
ENDM

	const anim_obp1_command ; $f0
anim_obp1: MACRO
	db anim_obp1_command
	db \1 ; colors
ENDM

	const anim_keepsprites_command ; $f1
anim_keepsprites: MACRO
	db anim_keepsprites_command
ENDM

	const anim_if_param_equal_command ; $f2
...
ENDM
	...
	const anim_setvar_command ; $f3
anim_setvar: MACRO
	db anim_setvar_command
	db \1 ; value
ENDM

	const anim_incvar_command ; $f4
anim_incvar: MACRO
	db anim_incvar_command
ENDM

	const anim_if_var_equal_command ; $f5
...
ENDM
	...
	const anim_jump_command ; $f6
anim_jump: MACRO
	db anim_jump_command
	dw \1 ; address
ENDM

	const anim_loop_command ; $f7
anim_loop: MACRO
...
ENDM
	...
	const anim_call_command ; $f8
anim_call: MACRO
	db anim_call_command
	dw \1 ; address
ENDM

	const anim_ret_command ; $f9
anim_ret: MACRO
	db anim_ret_command
ENDM
