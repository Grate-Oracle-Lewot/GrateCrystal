...
ENDM
	...
	const anim_dummy_command ; d0 - d5
anim_dummy: MACRO
	db anim_dummy_command
ENDM

	const anim_obj_command ; $d6
anim_obj: MACRO
	db anim_obj_command
if _NARG <= 4
	db \1 ; object
...
ENDM
	...
	const anim_1gfx_command ; $d7
anim_1gfx: MACRO
	db anim_1gfx_command
	db \1 ; gfx1
ENDM

	const anim_2gfx_command ; $d8
anim_2gfx: MACRO
...
ENDM
	...
	const anim_incobj_command ; $dc
anim_incobj: MACRO
	db anim_incobj_command
	db \1 ; object_id
ENDM

	const anim_setobj_command ; $dd
anim_setobj: MACRO
...
ENDM
	...
	const anim_cry_command ; $e7
anim_cry: MACRO
	db anim_cry_command
	db \1 ; pitch
ENDM

	const anim_minimizeopp_command ; $e8
anim_minimizeopp: MACRO
	db anim_minimizeopp_command
ENDM

	const anim_oamon_command ; $e9
anim_oamon: MACRO
	db anim_oamon_command
ENDM

	const anim_oamoff_command ; $ea
anim_oamoff: MACRO
	db anim_oamoff_command
ENDM

	const anim_clearobjs_command ; $eb
anim_clearobjs: MACRO
	db anim_clearobjs_command
ENDM

	const anim_beatup_command ; $ec
anim_beatup: MACRO
	db anim_beatup_command
ENDM

	const anim_updateactorpic_command ; $ed
anim_updateactorpic: MACRO
	db anim_updateactorpic_command
ENDM

	const anim_minimize_command ; $ee
anim_minimize: MACRO
	db anim_minimize_command
ENDM

	const anim_setbgpal_command ; ef
anim_setbgpal: MACRO
...
ENDM
	...
	const anim_setobjpal_command ; f0
...
ENDM
	...
	const anim_if_param_and_command ; $f1
...
ENDM
	...
	const anim_jumpuntil_command ; $f2
anim_jumpuntil: MACRO
	db anim_jumpuntil_command
	dw \1 ; address
ENDM

	const anim_bgeffect_command ; $f3
anim_bgeffect: MACRO
...
ENDM
	...
	const anim_bgp_command ; $f4
anim_bgp: MACRO
	db anim_bgp_command
	db \1 ; colors
ENDM

	const anim_obp0_command ; $f5
anim_obp0: MACRO
	db anim_obp0_command
	db \1 ; colors
ENDM

	const anim_obp1_command ; $f6
anim_obp1: MACRO
	db anim_obp1_command
	db \1 ; colors
ENDM

	const anim_keepsprites_command ; $f7
