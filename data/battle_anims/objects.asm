...
; ANIM_OBJ_MIST
	battleanimobj RELATIVE_X | X_FLIP, $68, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_GRAY, ANIM_GFX_HAZE
; ANIM_OBJ_SMOG
	battleanimobj RELATIVE_X | X_FLIP, $68, BATTLEANIMFRAMESET_6F, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_GRAY, ANIM_GFX_HAZE
; ANIM_OBJ_HORN
...
; ANIM_OBJ_MOONBLAST
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_GRAY, ANIM_GFX_GLOBE
...
; ANIM_OBJ_ZEROBLAST
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_B3, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_ZEROBLAST
...
; ANIM_OBJ_U_TURN_LAUNCH
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GREEN, ANIM_GFX_EXPLOSION
; ANIM_OBJ_U_TURN_RISE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_GREEN, ANIM_GFX_EXPLOSION
; ANIM_OBJ_U_TURN_FALL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_GREEN, ANIM_GFX_EXPLOSION
; ANIM_OBJ_BLUE_BEAM
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_BEAM
; ANIM_OBJ_BLUE_BEAM_TIP
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_BLUE, ANIM_GFX_BEAM
; ANIM_OBJ_BIG_ICE_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS
; ANIM_OBJ_SMALL_ICE_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS
; ANIM_OBJ_RED_GEM
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_13, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_ICE
; ANIM_OBJ_GREEN_GEM
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_13, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GREEN, ANIM_GFX_ICE
; ANIM_OBJ_DARK_PULSE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_HIDDEN_POWER, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHARGE
; ANIM_OBJ_SILVER_SPARKLE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_AF, BATTLEANIMFUNC_USER_TO_TARGET, PAL_BATTLE_OB_GRAY, ANIM_GFX_SPEED
; ANIM_OBJ_HIT_BIG_YFIX_BLUE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_00, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_HIT
; ANIM_OBJ_HIT_YFIX_BLUE
