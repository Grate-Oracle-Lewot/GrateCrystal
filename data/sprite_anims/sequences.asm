...
; SPRITE_ANIM_OBJ_MINIGAME_PIKACHU
	db SPRITE_ANIM_FRAMESET_MINIGAME_PIKACHU,          SPRITE_ANIM_SEQ_MINIGAME_PIKACHU,          SPRITE_ANIM_DICT_GS_INTRO_2
; SPRITE_ANIM_OBJ_MINIGAME_PIKACHU_TAIL
	db SPRITE_ANIM_FRAMESET_MINIGAME_PIKACHU_TAIL,     SPRITE_ANIM_SEQ_MINIGAME_PIKACHU,          SPRITE_ANIM_DICT_GS_INTRO_2
; SPRITE_ANIM_OBJ_MINIGAME_OMANYTE
