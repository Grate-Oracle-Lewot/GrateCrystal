...
; SPRITE_ANIM_INDEX_MINIGAME_PIKACHU
	db SPRITE_ANIM_FRAMESET_MINIGAME_PIKACHU_1,        SPRITE_ANIM_SEQ_MINIGAME_PIKACHU,          SPRITE_ANIM_DICT_GS_INTRO_2
; SPRITE_ANIM_INDEX_MINIGAME_PIKACHU_TAIL
	db SPRITE_ANIM_FRAMESET_MINIGAME_PIKACHU_TAIL_1,   SPRITE_ANIM_SEQ_MINIGAME_PIKACHU,          SPRITE_ANIM_DICT_GS_INTRO_2
; SPRITE_ANIM_INDEX_MINIGAME_OMANYTE
	db SPRITE_ANIM_FRAMESET_MINIGAME_OMANYTE,          SPRITE_ANIM_SEQ_MINIGAME_OMANYTE,          SPRITE_ANIM_DICT_GS_INTRO
; SPRITE_ANIM_INDEX_MINIGAME_JIGGLYPUFF
	db SPRITE_ANIM_FRAMESET_MINIGAME_JIGGLYPUFF,       SPRITE_ANIM_SEQ_MINIGAME_JIGGLYPUFF,       SPRITE_ANIM_DICT_GS_INTRO_2
; SPRITE_ANIM_INDEX_MINIGAME_NOTE
	db SPRITE_ANIM_FRAMESET_MINIGAME_NOTE,             SPRITE_ANIM_SEQ_MINIGAME_NOTE,             SPRITE_ANIM_DICT_GS_INTRO_2
