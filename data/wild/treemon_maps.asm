...
RockMonMaps:
	...
	treemon_map MOUNT_MOON_B2F,            ROCKMON_SET_DIGLETT
	treemon_map ROCK_TUNNEL_B1F,           ROCKMON_SET_DIGLETT
	treemon_map CERULEAN_CAVE_2F,          ROCKMON_SET_KANTO
	treemon_map CERULEAN_CAVE_B1F,         ROCKMON_SET_KANTO
	treemon_map SAFARI_ZONE_GATE,          ROCKMON_SET_KANTO
	db -1
