...
.ShigekiMorimoto:     db "SoupPotato SourApple@"      ; "もりもと　しげき@"
.SousukeTamada:       db "    Lucas Wright@"          ; "たまだ　そうすけ@"
.TakenoriOota:        db "      PIKACHU25@"           ; "おおた　たけのり@"
.KenSugimori:         db "      LuigiTKO@"            ; "すぎもり　けん@"
.MotofumiFujiwara:    db "     Percivale@"            ; "ふじわら　もとふみ@"
.AtsukoNishida:       db "     SonicRay100@"          ; "にしだ　あつこ@"
.MuneoSaito:          db "      Nick-PC@"             ; "さいとう　むねお@"
.SatoshiOota:         db "   FIQ     Seasick@"        ; "おおた　さとし@"
.RenaYoshikawa:       db "     Jordanar21@"           ; "よしかわ　れな@"
.JunOkutani:          db " i-am-the-pokeman@"         ; "おくたに　じゅん@"
.HironobuYoshida:     db " Victoria Lacroix@"         ; "よしだ　ひろのぶ@"
.AsukaIwashita:       db "  Chikorita-Lover@"         ; "いわした　あすか@"
.GoIchinose:          db "     gordjscott@"           ; "いちのせ　ごう@"
.MorikazuAoki:        db "       mimi-m@"             ; "あおき　もりかず@"
...
.TetsujiOota:         db " Fredrik Ljungdahl@"        ; "おおた　てつじ@"
.NclSuperMarioClub:   db "     JimB16@"               ; "スーパーマりオクラブ@"
...
.TakashiKawaguchi:    db "      xCrystal@"            ; "かわぐち　たかし@"
.TsunekazuIshihara:   db " Tom Wang     Gabe@"        ; "いしはら　つねかず@"
.HiroshiYamauchi:     db "   hyperdriveguy@"          ; "やまうち　ひろし@"
...
.HisashiSogabe:       db "      CHAMBER@"             ; "そがべ　ひさし@"
.KeitaKagaya:         db "      SOLO0993@"            ; "かがや　けいた@"
.YoshinoriMatsuda:    db "    BLUE EMERALD@"          ; "まつだ　よしのり@"
.HitomiSato:          db "     Helfexen@"             ; "さとう　ひとみ@"
.ToruOsawa:           db "      SnDream@"             ; "おおさわ　とおる@"
.TakaoOhara:          db "   Programmerino@"          ; "おおはら　たかお@"
.YuichiroIto:         db "      Sanqui@"              ; "いとう　ゆういちろう@"
...
.MikihiroIshikawa:    db "     igidrau@"              ; "いしかわ　みきひろ@"
...
.SethMcMahill:        db "      mid-kid@"
.HirotoAlexander:     db "      pfero@"
...
.Programmers:         db "      anmart@"              ; "プログラム@"
.GraphicsDirector:    db "   Emi Monserrate@"         ; "グラフィック　ディレクター@"
.MonsterDesign:       db "     growlie777@"           ; "#　デザイン@"
...
.UsCoordination:      db "  ArtUnderTheArch@"
.TextTranslation:     db "      ariscop@"
.PaadTesting:         db "    FrenchOrange@"
