...
.JunichiMasuda:       db "   ax6      Idain@"         ; "ますだ　じゅんいち@"
.TetsuyaWatanabe:     db " GBC-OG      Neslug@"       ; "わたなべ　てつや@"
.ShigekiMorimoto:     db " Fredrik Ljungdahl@"        ; "もりもと　しげき@"
.SousukeTamada:       db " LuigiTKO   yenatch@"       ; "たまだ　そうすけ@"
.TakenoriOota:        db "     PIKACHU25@"            ; "おおた　たけのり@"
.KenSugimori:         db "     LostImpact@"           ; "すぎもり　けん@"
.MotofumiFujiwara:    db "   hyperdriveguy@"          ; "ふじわら　もとふみ@"
.AtsukoNishida:       db "     SonicRay100@"          ; "にしだ　あつこ@"
.MuneoSaito:          db " Nick-PC    Gold Z@"        ; "さいとう　むねお@"
...
.KohjiNishino:        db "    RainbowDevs@"           ; "にしの　こうじ@"
.KenjiMatsushima:     db "    DamienDoury@"           ; "まつしま　けんじ@"
.ToshinobuMatsumiya:  db "   coco-bandicoot@"         ; "まつみや　としのぶ@"
...
.Sarugakucho:         db " LAKE   FIQ   MCboy@"         ; "さるがくちょう@"
.AkitoMori:           db "    Ryan Tandy@"            ; "もり　あきと@"
.TakahiroHarada:      db "  Ben Hetherington@"        ; "はらだ　たかひろ@"
.TohruHashimoto:      db "     surskitty@"            ; "はしもと　とおる@"
.NoboruMatsumoto:     db "    Remy Oukaour@"          ; "まつもと　のぼる@"
...
.HiroyukiZinnai:      db "   ElectroDeoxys@"          ; "じんない　ひろゆき@"
.KunimiKawamura:      db "  luckytyphlosion@"         ; "かわむら　くにみ@"
.HisashiSogabe:       db " CHAMBER   SOLO0993@"       ; "そがべ　ひさし@"
.KeitaKagaya:         db "    Th3Element05@"          ; "かがや　けいた@"
.YoshinoriMatsuda:    db "    BLUE EMERALD@"          ; "まつだ　よしのり@"
.HitomiSato:          db "     Helfexen@"             ; "さとう　ひとみ@"
.ToruOsawa:           db " celadonk   SnDream@"       ; "おおさわ　とおる@"
.TakaoOhara:          db "   Programmerino@"          ; "おおはら　たかお@"
.YuichiroIto:         db "    Chaos Rush@"            ; "いとう　ゆういちろう@"
.TakaoShimizu:        db "     AntonioND@"            ; "しみず　たかお@"
.Planning:            db "   JustRegularLuna"
                    next "   CelestialAmber"          ; "きかくかいはつぶ@"
                    next "     Neil Basu@"
.KeitaNakamura:       db "   aljohnston112@"          ; "なかむら　けいた@"
.HirotakaUemura:      db "   Daniel Shumway@"         ; "うえむら　ひろたか@"
.HiroakiTamura:       db "     Caverns4@"             ; "たむら　ひろあき@"
.NoriakiSakaguchi:    db " Lhivorde     MOLLY@"       ; "さかぐち　のりあき@"
...
.NobOgasawara:        db "   froggestspirit@"
.SethMcMahill:        db "The Void    roukaour@"
.HirotoAlexander:     db "  pfero     mid-kid@"
.TeresaLillygren:     db "     8-bit Zeta@"
.ThomasHertzog:       db "    Yoann Fievez@"
.ErikJohnson:         db "     iimarckus@"
.HiroNakamura:        db "    TriteHexagon@"
.TerukiMurakawa:      db "  Colton G. Rushton@"
.KazuyoshiOsawa:      db "   Daniel Harding@"
.KimikoNakamichi:     db "    bbbbbbbbba@"
...
.GraphicsDesign:      db "  7Soul    SCMidna@"        ; "グラフィック　デザイン@"
.Music:               db " Kyle Wayne LaCroix@"       ; "おんがく@"
.SoundEffects:        db "   Eldred Habert@"          ; "サウンド　エフェクト@"
.GameDesign:          db "     nayru62@"              ; "ゲームデザイン@"
.GameScenario:        db "   Rena Kunisaki@"          ; "シナりオ@"
.ToolProgramming:     db " rawr51919   KDLPro@"       ; "ツール　プログラム@"
...
.MobileStadiumDir:    db "    Jules Blok@"            ; "モバイルスタジアム　ディレクター@"
.Coordination:        db "    i0brendan0@"            ; "コーディネーター@"
.UsVersionStaff:      db "      Rangi42@"
.UsCoordination:      db "    FrenchOrange@"
.TextTranslation:     db " boonzeet  EXGomora@"
