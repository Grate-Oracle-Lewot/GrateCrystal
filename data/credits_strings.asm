...
.HironobuYoshida:     db "       Idain@"              ; "よしだ　ひろのぶ@"
...
.MonsterDesign:       db " Rangi42    Sylvie@"        ; "#　デザイン@"
...
.UsVersionStaff:      db "     growlie777@"
.UsCoordination:      db "      anmart@"
