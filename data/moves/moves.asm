...
move: MACRO
	...
	db \3 ; power
	db \4 | \5 ; type
	db \6 percent + 1 ; accuracy
	db \7 ; PP
	db \8 percent + 1 ; effect chance
...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move GUILLOTINE,   EFFECT_OHKO,                0, STEEL,        PHYSICAL,  20,  5,   0
	move SIGNAL_BEAM,  EFFECT_CONFUSE_HIT,        75, BUG,          SPECIAL,  100, 15,  10
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, FIGHTING,     STATUS,   100, 15,   0
	...
	move BIND,         EFFECT_TRAP_TARGET,        40, NORMAL,       PHYSICAL,  85, 25,   0
	...
	move HORN_DRILL,   EFFECT_OHKO,                1, NORMAL,       PHYSICAL,  20,  5,   0
	move TACKLE,       EFFECT_NORMAL_HIT,         40, NORMAL,       PHYSICAL, 100, 40,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,       PHYSICAL, 100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        40, DRAGON,       PHYSICAL,  85, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL,       PHYSICAL, 100, 25,   0
	move THRASH,       EFFECT_RAMPAGE,            95, NORMAL,       PHYSICAL,  95, 15,   0
	...
	move SING,         EFFECT_SLEEP,               0, NORMAL,       STATUS,    55, 25,   0
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,       STATUS,    70, 30,   0
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        200, NORMAL,       SPECIAL,  100,  5,   0
	move PECK,         EFFECT_NORMAL_HIT,         40, FLYING,       PHYSICAL, 100, 35,   0
	move DRILL_PECK,   EFFECT_DEFENSE_DOWN_HIT,   80, FLYING,       PHYSICAL, 100, 15,  20
	move SUBMISSION,   EFFECT_RECOIL_HIT,         90, FIGHTING,     PHYSICAL, 100, 20,   0
	move LOW_KICK,     EFFECT_EVASION_DOWN_HIT,   50, FIGHTING,     PHYSICAL,  90, 25, 100
	move COUNTER,      EFFECT_COUNTER,             1, DARK,         PHYSICAL, 100, 20,   0
	...
	move FISSURE,      EFFECT_FISSURE,             1, GROUND,       PHYSICAL,  20,  5,   0
	move DIG,          EFFECT_DIG,                70, GROUND,       PHYSICAL, 100, 15,   0
	...
	move SCALD,        EFFECT_BURN_HIT,           70, WATER,        SPECIAL,  100, 15,  30
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        60, WATER,        PHYSICAL,  85, 15,   0
	...
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     20, WATER,        SPECIAL,  100, 40,  10
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        75, NORMAL,       PHYSICAL, 100, 15,  30
	move SPORE,        EFFECT_SLEEP,               0, GRASS,        STATUS,   100,  5,   0
	...
	move HYPER_FANG,   EFFECT_LEECH_HIT,          84, NORMAL,       PHYSICAL,  90, 10,   0
	...
	move SPIDER_WEB,   EFFECT_MEAN_LOOK,           0, BUG,          STATUS,   100,  5,   0
	move MIND_READER,  EFFECT_LOCK_ON,             0, PSYCHIC_TYPE, STATUS,   100,  5,   0
	move NIGHTMARE,    EFFECT_NIGHTMARE,           0, GHOST,        STATUS,    50, 10,   0
	...
	move SPITE,        EFFECT_SPITE,               0, GHOST,        STATUS,   100, 20,   0
	...
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,       STATUS,   100, 10,   0
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,       STATUS,   100, 10,   0
	move BLITZKRIEG,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,     PHYSICAL,  50,  5, 100
	...
	move OUTRAGE,      EFFECT_RAMPAGE,            95, DRAGON,       PHYSICAL,  95, 10,   0
	move SANDSTORM,    EFFECT_SANDSTORM,           0, ROCK,         STATUS,   100,  5,   0
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          80, GRASS,        SPECIAL,  100,  5,   0
	move ACROBATICS,   EFFECT_ACROBATICS,         55, FLYING,       PHYSICAL, 100, 10,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     70, STEEL,        PHYSICAL,  90, 20,  50
	move MEAN_LOOK,    EFFECT_MEAN_LOOK,           0, DARK,         STATUS,   100,  5,   0
	move ATTRACT,      EFFECT_ATTRACT,             0, FAIRY,        STATUS,   100, 10,   0
	move SLEEP_TALK,   EFFECT_SLEEP_TALK,          0, NORMAL,       STATUS,   100, 15,   0
	...
	move MIRROR_COAT,  EFFECT_MIRROR_COAT,         1, FAIRY,        SPECIAL,  100, 20,   0
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, PSYCHIC_TYPE, STATUS,   100, 10,   0
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       84, NORMAL,       PHYSICAL, 100,  5,   0
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,         SPECIAL,  100, 10,  10
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    84, GHOST,        SPECIAL,  100, 15,  20
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        40, WATER,        SPECIAL,  100, 15,   0
