...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         85, ROCK,         PHYSICAL, 100, 15,  30
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      110, ELECTRIC,     SPECIAL,   50,  5, 100
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        120, FIGHTING,     PHYSICAL,  85,  5,   0
