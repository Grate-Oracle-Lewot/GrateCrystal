...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         85, ROCK,         PHYSICAL, 100, 15,  20
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        110, FIGHTING,     PHYSICAL,  85,  5,   0
	...
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    85, GHOST,        SPECIAL,  100, 15,  20
