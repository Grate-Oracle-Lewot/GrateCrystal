...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          20, FAIRY,        PHYSICAL,  90, 10,   0
	...
	move GUILLOTINE,   EFFECT_OHKO,                0, STEEL,        PHYSICAL,  42,  5,   0
	move SIGNAL_BEAM,  EFFECT_CONFUSE_HIT,        75, BUG,          SPECIAL,  100, 15,  10
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, FIGHTING,     STATUS,   100, 30,   0
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         60, FIGHTING,     PHYSICAL,  75, 15, 100
	...
	move HORN_DRILL,   EFFECT_OHKO,                1, NORMAL,       PHYSICAL,  42,  5,   0
	...
	move THRASH,       EFFECT_RAMPAGE,            90, NORMAL,       PHYSICAL,  90, 20,   0
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,       STATUS,    60, 20,   0
	...
	move LOW_KICK,     EFFECT_EVASION_DOWN_HIT,   50, FIGHTING,     PHYSICAL,  90, 20, 100
	...
	move FISSURE,      EFFECT_OHKO,                1, GROUND,       PHYSICAL,  42,  5,   0
	...
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,       STATUS,   100, 40,   0
	...
	move METRONOME,    EFFECT_METRONOME,           0, FAIRY,        STATUS,   100, 10,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,       PHYSICAL,  80, 10,   0
	...
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,       STATUS,    84, 30,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC_TYPE, SPECIAL,  100, 15,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,       STATUS,    60, 40,   0
	move DAZZLY_GLEAM, EFFECT_NORMAL_HIT,         80, FAIRY,        SPECIAL,  100, 10,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          50, BUG,          PHYSICAL, 100, 15,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,       STATUS,    84, 10,   0
	move SKY_ATTACK,   EFFECT_FLY,               140, FLYING,       PHYSICAL,  90,  5,   0
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  80, STEEL,        SPECIAL,  100, 10,  10
	...
	move SNORE,        EFFECT_SNORE,              40, NORMAL,       SPECIAL,  100, 25,  30
	...
	move BONE_RUSH,    EFFECT_MULTI_HIT,          40, GROUND,       PHYSICAL,  90, 10,   0
	...
	move PRESENT,      EFFECT_PRESENT,             1, FAIRY,        PHYSICAL, 100, 15,   0
	...
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,   120, FAIRY,        SPECIAL,   80,  5,  30
