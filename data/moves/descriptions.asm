...
MinimizeDescription:
	db   "The user shrinks,"
	next "raising evasion.@"

SmokescreenDescription:
	db   "Reduces accuracy"
	next "by blowing smoke.@"
