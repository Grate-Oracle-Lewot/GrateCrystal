InverseTypeMatchups:
	...
	db CURSE_TYPE,   FIRE,         SUPER_EFFECTIVE
	db CURSE_TYPE,   GRASS,        NOT_VERY_EFFECTIVE
	db CURSE_TYPE,   FLYING,       NOT_VERY_EFFECTIVE
