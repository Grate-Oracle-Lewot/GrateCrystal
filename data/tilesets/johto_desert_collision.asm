	...
	tilecoll WALL, FLOOR, FLOOR, WALL ; 22
	...
	tilecoll FLOOR, HOP_DOWN, FLOOR, WALL ; 3b
	...
	tilecoll HOP_RIGHT, WALL, HOP_RIGHT, WALL ; 7d
	tilecoll WALL, HOP_DOWN_LEFT, WALL, WALL ; 7e
	tilecoll HOP_DOWN_RIGHT, WALL, WALL, WALL ; 7f
