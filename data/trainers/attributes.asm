...
; Cal
	db FULL_RESTORE, FULL_RESTORE ; items
	db 30 ; base reward
	dw AI_BASIC | AI_SETUP | AI_SMART | AI_AGGRESSIVE | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_SIMPLE
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Schoolboy
	db NO_ITEM, NO_ITEM ; items
	db 13 ; base reward
	dw AI_BASIC | AI_SETUP | AI_TYPES | AI_CAUTIOUS | AI_STATUS | AI_STUBBORN
...
; CooltrainerM
	...
	db 17 ; base reward
	dw AI_BASIC | AI_SETUP | AI_SMART | AI_AGGRESSIVE | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_PRAGMATIC
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Gentleman
	...
	db 23 ; base reward
	dw AI_BASIC | AI_SETUP | AI_AGGRESSIVE | AI_STATUS | AI_AGGRESSIVE_2
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Teacher
	db FULL_HEAL, NO_ITEM ; items
	db 1 ; base reward
	dw AI_BASIC | AI_AGGRESSIVE | AI_STATUS | AI_PRAGMATIC
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Biker
	db NO_ITEM, NO_ITEM ; items
	db 13 ; base reward
	dw AI_BASIC | AI_TYPES | AI_STATUS | AI_RISKY | AI_TROLL
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Juggler
	db NO_ITEM, NO_ITEM ; items
	db 15 ; base reward
	dw AI_BASIC | AI_TYPES | AI_SMART | AI_STATUS | AI_TROLL
	dw CONTEXT_USE | SWITCH_OFTEN
...
; ExecutiveM
	...
	db 0 ; base reward
	dw AI_BASIC | AI_SETUP | AI_TYPES | AI_SMART | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_PRAGMATIC
	dw CONTEXT_USE | SWITCH_SOMETIMES

; Psychic T
	db X_SPECIAL, NO_ITEM ; items
	db 13 ; base reward
	dw AI_BASIC | AI_TYPES | AI_OPPORTUNIST | AI_CAUTIOUS | AI_STATUS | AI_PRAGMATIC
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Camper
	db NO_ITEM, NO_ITEM ; items
	db 10 ; base reward
	dw AI_BASIC | AI_STATUS | AI_STUBBORN
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Medium
	...
	db 15 ; base reward
	dw AI_BASIC | AI_SETUP | AI_TYPES | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_TROLL
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; GruntF
	db NO_ITEM, NO_ITEM ; items
	db 0 ; base reward
	dw AI_BASIC | AI_TYPES | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_PRAGMATIC
	dw CONTEXT_USE | SWITCH_SOMETIMES

; Mystic
	db X_ACCURACY, FULL_RESTORE ; items
	db 30 ; base reward
	dw AI_BASIC | AI_SETUP | AI_SMART | AI_AGGRESSIVE | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_TROLL | AI_SIMPLE
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Agatha
	db FULL_RESTORE, FULL_RESTORE ; items
	db 0 ; base reward
	dw AI_BASIC | AI_SETUP | AI_SMART | AI_AGGRESSIVE | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_TROLL
	dw CONTEXT_USE | SWITCH_OFTEN
