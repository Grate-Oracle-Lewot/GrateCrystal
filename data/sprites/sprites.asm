...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite ADSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
	...
	overworld_sprite LewotSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite PercySpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN
