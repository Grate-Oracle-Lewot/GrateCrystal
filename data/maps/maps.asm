...
MapGroup_Dungeons:
	...
	map NationalPark, TILESET_PARK, ROUTE, LANDMARK_NATIONAL_PARK, MUSIC_NATIONAL_PARK, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map NationalParkBugContest, TILESET_PARK, ROUTE, LANDMARK_NATIONAL_PARK, MUSIC_BUG_CATCHING_CONTEST, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	...
	map RuinsOfAlphAerodactylWordRoom, TILESET_AERODACTYL_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodUnderground, TILESET_GATE, DUNGEON, LANDMARK_GOLDENROD_CITY, MUSIC_SILPH_CO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodUndergroundSwitchRoomEntrances, TILESET_ELITE_FOUR_ROOM, DUNGEON, LANDMARK_GOLDENROD_CITY, MUSIC_SILPH_CO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreB1F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_GOLDENROD_CITY, MUSIC_SILPH_CO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodUndergroundWarehouse, TILESET_UNDERGROUND, DUNGEON, LANDMARK_GOLDENROD_CITY, MUSIC_SILPH_CO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map UndergroundPath, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_SILPH_CO, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map IcePathArticunoChamber, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map RockTunnelZapdosChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map SilverCaveMoltresChamber, TILESET_ELITE_FOUR_ROOM, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MewAntechamber, TILESET_JOHTO, ROUTE, LANDMARK_TOHJO_FALLS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_AUTO, FISHGROUP_WHIRL_ISLANDS
	map MewChamber, TILESET_ICE_PATH, CAVE, LANDMARK_TOHJO_FALLS, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamCavePuzzleChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamCave1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamCaveB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_SS_ANNE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map SafariZone, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map DarkCave2F, TILESET_TOWER, DUNGEON, LANDMARK_DARK_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForest, TILESET_PARK, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map SilphCo2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo3F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo4F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo5F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo6F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo7F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo8F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo9F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo10F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo11F, TILESET_UNDERGROUND, INDOOR, LANDMARK_SILPH_CO, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AbandonedLab1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_ABANDONED_LAB, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map AbandonedLab2F, TILESET_UNDERGROUND, INDOOR, LANDMARK_ABANDONED_LAB, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map AbandonedLabRoof, TILESET_TOWER, ROUTE, LANDMARK_ABANDONED_LAB, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AbandonedLabB1F, TILESET_UNDERGROUND, INDOOR, LANDMARK_ABANDONED_LAB, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map Route19FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_47, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map Route4, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_REMORAID
...
MapGroup_Violet:
	...
	map Route35NationalParkGate, TILESET_GATE, INDOOR, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStore1F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreRoof, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodGameCornerBackroom, TILESET_GAME_CORNER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GAME_CORNER, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Pewter:
	...
	map PewterGym, TILESET_TOWER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map TinTowerRoof, TILESET_TOWER, ROUTE, LANDMARK_TIN_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_MORN, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map SafariZoneGate, TILESET_GATE, GATE, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DARK, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavRadioTower2F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAV_RADIO_TOWER, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map Route17, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_17, MUSIC_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CeladonCity, TILESET_KANTO, TOWN, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonDeptStore1F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route2NorthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2SouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadGate, TILESET_GATE, GATE, LANDMARK_ROUTE_26, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route22House, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_22, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map Route48, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_48, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
