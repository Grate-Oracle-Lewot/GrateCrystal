...
MapGroup_Dungeons:
	...
	map UnionCaveSlowpokeWellLink, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_DARK, FISHGROUP_OCEAN
	...
	map SeafoamCaveB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_SS_ANNE, TRUE, PALETTE_DARK, FISHGROUP_DRATINI
...
MapGroup_FastShip:
	...
	map TinTowerRoof, TILESET_TOWER, ROUTE, LANDMARK_TIN_TOWER, MUSIC_TIN_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
