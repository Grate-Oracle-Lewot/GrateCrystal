...
MapGroup_Viridian:
	...
	map Route2North, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route2NorthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
