...
MapGroup_Dungeons:
	...
	map SafariZone, TILESET_FOREST, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Fuchsia:
	...
	map SafariZoneGate, TILESET_GATE, GATE, LANDMARK_FUCHSIA_CITY, LANDMARK_FUCHSIA_CITY, FALSE, PALETTE_DARK, FISHGROUP_SHORE
