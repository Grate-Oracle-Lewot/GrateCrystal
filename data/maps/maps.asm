...
MapGroup_Dungeons:
	...
	map MewAntechamber, TILESET_JOHTO, CAVE, LANDMARK_TOHJO_FALLS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	...
	map ViridianForest, TILESET_PARK, CAVE, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, TRUE, PALETTE_NITE, FISHGROUP_POND
