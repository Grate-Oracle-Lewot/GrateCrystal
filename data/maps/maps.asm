...
MapGroup_Dungeons:
	...
	map IlexForest, TILESET_FOREST, CAVE, LANDMARK_ILEX_FOREST, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_POND
	...
	map SafariZone, TILESET_FOREST, CAVE, LANDMARK_SAFARI_ZONE, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Fuchsia:
	...
	map SafariZoneGate, TILESET_GATE, GATE, LANDMARK_FUCHSIA_CITY, LANDMARK_FUCHSIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
