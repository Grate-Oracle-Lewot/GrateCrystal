...
ENDM
	...
	connection west, Route22, ROUTE_22, -35
	...
	connection east, ViridianCity, VIRIDIAN_CITY, 35
	...
	map_attributes Gate2F, GATE_2F, $00, 0
	...
	map_attributes CeruleanJeweler, CERULEAN_JEWELER, $00, 0
	...
	map_attributes GoldenrodGameCornerBackroom, GOLDENROD_GAME_CORNER_BACKROOM, $00, 0
	...
	map_attributes CianwoodDarkroom, CIANWOOD_DARKROOM, $00, 0
