...
if DEF(_SIX_PIKACHUS)
	dw EVENT_CHIKORITA_POKEBALL_IN_ELMS_LAB
	dw EVENT_TOTODILE_POKEBALL_IN_ELMS_LAB
	dw -1 ; end
else
if DEF(_LETS_GO_STARTERS) || DEF(_SLOW_STARTERS) || DEF(_TURBIN_STARTERS)
	dw EVENT_CYNDAQUIL_POKEBALL_IN_ELMS_LAB
	dw -1 ; end
	dw 0 ; buffer
else
	dw -1 ; end
...
ENDM
	...
	initvarsprite SPRITE_LINK_TRAINER, SPRITE_CHRIS
	initvarsprite SPRITE_TRAINER_HOUSE, SPRITE_CHRIS
	initvarsprite SPRITE_JESSIE_DISGUISE, SPRITE_GENTLEMAN
	initvarsprite SPRITE_JAMES_DISGUISE, SPRITE_BEAUTY
	db -1 ; end
