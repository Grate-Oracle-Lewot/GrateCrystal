...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_HAPPY,     GENGAR,     XATU,       "VAATU@@@@@@", $1F, $FF, TWISTEDSPOON, 15616, "JUAN@@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, MAGCARGO,   LAPRAS,     "LA PROIX@@@", $3F, $FF, CATCH_CHARM,  35768, "LIAM@@@@@@@", TRADE_GENDER_FEMALE
	npctrade TRADE_DIALOGSET_NEWBIE,    DITTO,      DITTO,      "THINGOID@@@", $11, $F1, TM_SKETCH,    42124, "COPYCAT@@@@", TRADE_GENDER_EITHER
