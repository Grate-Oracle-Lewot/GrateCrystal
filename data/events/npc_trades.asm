...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_HAPPY,     HAUNTER,    XATU,       "VAATU@@@@@@", $66, $6D, MYSTERYBERRY, 15616, "JUAN@@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, MAGCAEGO,   LAPRAS,     "LA PROIX@@@", $3F, $FF, CATCH_CHARM,  35768, "LIAM@@@@@@@", TRADE_GENDER_FEMALE
