...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, BELLSPROUT, ONIX,       "SOLIDSNAKE@", $96, $66, NOISEMAKER,   48926, "KYLE@@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_GIRL,      CHANSEY,    AERODACTYL, "PTERRY@@@@@", $96, $66, GOLD_BERRY,   26491, "KIM@@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, DUGTRIO,    MAGNETON,   "TRIHARD@@@@", $96, $66, METAL_COAT,   50082, "FOREST@@@@@", TRADE_GENDER_EITHER
