...
.e:        db SKARMORY, AIPOM, ESPEON, HITMONCHAN, JIRK, ELECTABUZZ, ENTEI, -1
...
.hi_bi_pi: db COTTONEE, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, FLOGISTAN, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, CASTAWEIGH, WHIMSICOTT, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
