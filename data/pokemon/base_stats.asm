...
INCLUDE "data/pokemon/base_stats/flogistan.asm"
...
INCLUDE "data/pokemon/base_stats/snoconey.asm"
INCLUDE "data/pokemon/base_stats/jirk.asm"
INCLUDE "data/pokemon/base_stats/castaweigh.asm"
