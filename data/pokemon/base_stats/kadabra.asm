	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, RAIN_DANCE, ENDURE, RETURN, DIG, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, THUNDERPUNCH, DREAM_EATER, FALSE_SWIPE, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, DARK_PULSE, NIGHT_TERROR, SUBSTITUTE, TELEPORT, FLASH, TRI_ATTACK, AURA_SPHERE
	; end
