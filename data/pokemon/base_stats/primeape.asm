	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, AVALANCHE, PROTECT, ENDURE, POISON_JAB, THUNDER, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, THIEF, FIRE_PUNCH, SUBSTITUTE, SHADOW_CLAW, U_TURN, STRENGTH, ROCK_SMASH, THUNDERBOLT
	; end
