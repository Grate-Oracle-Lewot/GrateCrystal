	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROAR, TOXIC, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, SWIFT, REST, FAIRY_WIND, MOONBLAST, HAIL, SUBSTITUTE, CUT, SURF, WHIRLPOOL, WATERFALL, ROCK_SMASH, ICE_BEAM, TRI_ATTACK, AEROBLAST, AURA_SPHERE
	; end
