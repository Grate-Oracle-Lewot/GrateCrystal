	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, TOXIC, BLITZKRIEG, SELFDESTRUCT, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, AVALANCHE, PROTECT, RAIN_DANCE, ENDURE, SOLARBEAM, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, FIRE_BLAST, DEFENSE_CURL, DREAM_EATER, REST, NIGHTMARE, FAIRY_WIND, MOONBLAST, NIGHT_TERROR, SUBSTITUTE, FLASH, FLAMETHROWER, TRI_ATTACK
	; end
