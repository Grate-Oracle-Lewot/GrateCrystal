	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROAR, TOXIC, BLITZKRIEG, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, SOLARBEAM, IRON_TAIL, RETURN, DIG, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, FIRE_BLAST, SWIFT, DREAM_EATER, REST, ATTRACT, THIEF, NIGHTMARE, DARK_PULSE, NIGHT_TERROR, SUBSTITUTE, STRENGTH, ROCK_SMASH, FLAMETHROWER, TRI_ATTACK
	; end
