...
MonMenuIcons:
	...
	db ICON_FOX         ; FLOGISTAN
	db ICON_FLEA        ; COTTONEE
	db ICON_FLEA        ; WHIMSICOTT
	...
	db ICON_FLOWER      ; SKIPLOOM
	db ICON_FLOWER      ; JUMPLUFF
	...
	db ICON_VOLTORB     ; SNOCONEY
	db ICON_BUG         ; JIRK
	db ICON_MANTINE     ; CASTAWEIGH
