...
; BattleTowerMons group 10
	...
	db TAUROS
	db KINGS_ROCK
	db SKULL_BASH, EARTHQUAKE, IRON_HEAD, FLAME_WHEEL
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SNEASEL
	db SCOPE_LENS
	db SHADOW_CLAW, ICE_PUNCH, STRENGTH, FAINT_ATTACK
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CASTAWEIGH
	db DICTIONARY
	db WATERFALL, CRUNCH, POISON_JAB, EARTHQUAKE
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db QUICK_CLAW
	db PSYCHIC_M, TOXIC, EGG_BOMB, GIGA_DRAIN
	dw 0 ; OT ID
	dt 1059860 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LANTURN
	db QUICK_CLAW
	db SURF, DAZZLY_GLEAM, BLITZKRIEG, CONFUSE_RAY
	dw 0 ; OT ID
	dt 1059860 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerExtraMons:
	table_width PARTYMON_STRUCT_LENGTH, BattleTowerExtraMons
	...
	db HITMONLEE
	db HARDHAT
	db REVERSAL, SUBSTITUTE, HI_JUMP_KICK, FORESIGHT
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
