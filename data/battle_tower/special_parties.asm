...
BattleTowerPryce:
	...
	db PILOSWINE
	db NEVERMELTICE
	db AVALANCHE, EARTHQUAKE, HAIL, BLIZZARD
	dw 0 ; OT ID
	dt 1059860 ; Exp
	; Stat exp
	bigdw 65535
...
BattleTowerClair:
	...
	db LUGIA
	db LEFTOVERS
	db ZEROBLAST, RECOVER, AIR_SLASH, DRAGON_PULSE
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65535
...
BattleTowerLewot:
	...
	db FERALIGATR
	db BERRY_JUICE
	db WATERFALL, CRUNCH, EARTHQUAKE, ZEROBLAST
	dw 0 ; OT ID
	dt 1059860 ; Exp
	; Stat exp
	bigdw 65535
...
BattleTowerRed:
	...
	db ESPEON
	db NOISEMAKER
	db AURA_SPHERE, REFLECT, POWER_GEM, PSYCHIC_M
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 65535
...
BattleTowerLi:
	...
	db VICTREEBEL
	db SCOPE_LENS
	db RAZOR_LEAF, POISON_JAB, SCALD, PROTECT
	dw 0 ; OT ID
	dt 949930 ; Exp
	; Stat exp
	bigdw 65535
