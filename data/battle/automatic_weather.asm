...
ENDM
	...
	auto_weather_map SILVER_CAVE_MOLTRES_CHAMBER, AUTOMATIC_SUN
	...
	auto_weather_map WHIRL_ISLAND_B2F, AUTOMATIC_HAIL
	...
	auto_weather_map ICE_PATH_ARTICUNO_CHAMBER, AUTOMATIC_HAIL
	...
	auto_weather_map SILVER_CAVE_ROOM_3, AUTOMATIC_SANDSTORM
