...
- Automatic weather in certain areas: sunlight in the National Park, the top of the Tin Tower, and Blaine's Gym; rain inside Slowpoke Well, the Whirl Islands, and Misty's Gym; Hail in the Ice Path and Lugia's chamber (since Lugia is Ice/Dragon now); and Sandstorms in Victory Road and Brock's Gym
...
- Occasionally, Pokémon seem to suddenly have the wrong stats mid-battle, and/or Pikachu forms will be missing their secondary types. I can never replicate this, so I don't know what triggers it, but it might have to do with switching out. The effect isn't permanent.
