...
- If you use Spikes while Spikes are already up, it lowers the opponent's Speed by one stage.
...
- Hail boosts Ice-type moves as well as buffeting battlers, and Sandstorm gives a 50% Special Defense boost to Rock-type Pokémon like in later generations, while Sunny Day gives a 50% Speed boost to Grass types
