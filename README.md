...
- Steel no longer resists Ghost or Psychic, and is now weak to Electric
...
- Removed: Splash, Razor Wind, Barrage, Constrict, Mimic, Detect, and Explosion (Selfdestruct is now as strong as Explosion)
...
- The one in Goldenrod who teaches Flamethrower, Thunderbolt, and Ice Beam will now teach moves as soon as you defeat Whitney, appears every day instead of just certain days of the week, and can now also teach Tri Attack
