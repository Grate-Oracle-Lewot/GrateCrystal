...
- Pseudo-Abilities:
  ...
  - All Fairy types have a 30% chance to infatuate opposite-gender attackers on contact
...
- A second floor to the Power Plant (similar layout to Gen I, no wild encounters; navigate to find the Manager, with optional Engineer battles)
...
- Due to no Mystery Gift, the Trainer House now has you fight a copy of your own party from the last time you saved
