...
.SUFFIXES:
.PHONY: all crystal kanto letsgo mice jinx hitmon nido cattle shucks new1 new2 fossil pseudo bird beast mew dragon onion miss no crystal11 clean tidy tools
.SECONDEXPANSION:
.PRECIOUS:
.SECONDARY:
