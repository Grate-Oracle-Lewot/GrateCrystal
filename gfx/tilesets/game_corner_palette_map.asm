	...
	tilepal 1, ROOF, ROOF, ROOF, ROOF, ROOF, ROOF, ROOF, YELLOW
	tilepal 1, YELLOW, RED, YELLOW, RED, GREEN, GREEN, BROWN, ROOF
	tilepal 1, ROOF, GRAY, GRAY, GRAY, GRAY, YELLOW, YELLOW, YELLOW
	tilepal 1, YELLOW, RED, YELLOW, RED, WATER, WATER, RED, RED
	tilepal 1, RED, RED, YELLOW, YELLOW, YELLOW, YELLOW, GRAY, GRAY
