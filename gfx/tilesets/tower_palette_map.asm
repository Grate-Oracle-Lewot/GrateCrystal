	...
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, YELLOW, WATER
	tilepal 1, WATER, WATER, YELLOW, YELLOW, BROWN, BROWN, ROOF, ROOF
	tilepal 1, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, ROOF, GRAY
	tilepal 1, WATER, WATER, YELLOW, YELLOW, BROWN, BROWN, ROOF, ROOF
