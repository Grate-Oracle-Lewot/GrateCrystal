	...
	tilepal 1, BROWN, BROWN, BROWN, RED, RED, GREEN, RED, RED
	tilepal 1, RED, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, RED
	tilepal 1, RED, RED, RED, RED, BROWN, BROWN, BROWN, BROWN
	tilepal 1, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN, GREEN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, GREEN, GREEN, BROWN, BROWN, BROWN, BROWN, BROWN, RED
	tilepal 1, RED, RED, RED, ROOF, ROOF, ROOF, ROOF, RED
	tilepal 1, GREEN, GREEN, BROWN, BROWN, BROWN, BROWN, BROWN, RED
	tilepal 1, RED, BROWN, BROWN, ROOF, ROOF, BROWN, BROWN, TEXT
