	...
	tilepal 0, GRAY, BROWN, BROWN, RED, RED, RED, BROWN, BROWN
	tilepal 0, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN, RED, GRAY
	tilepal 0, GRAY, BROWN, BROWN, RED, RED, RED, BROWN, BROWN
	tilepal 0, BROWN, BROWN, BROWN, BROWN, GREEN, GREEN, GREEN, BROWN
	tilepal 0, BROWN, BROWN, BROWN, RED, BROWN, BROWN, WATER, WATER
	tilepal 0, BROWN, BROWN, BROWN, BROWN, GREEN, GREEN, GREEN, BROWN
	tilepal 0, BROWN, BROWN, BROWN, RED, BROWN, BROWN, WATER, BROWN
