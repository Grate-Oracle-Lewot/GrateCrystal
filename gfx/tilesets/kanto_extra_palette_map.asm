	tilepal 0, GRAY, BROWN, BROWN, GREEN, BROWN, ROOF, ROOF, ROOF
	...
	tilepal 0, BROWN, GRAY, GRAY, BROWN, GRAY, GRAY, GRAY, RED
	tilepal 0, GREEN, GREEN, GREEN, ROOF, BROWN, BROWN, BROWN, BROWN
	tilepal 0, GREEN, GRAY, GRAY, BROWN, GRAY, GRAY, GRAY, GRAY
