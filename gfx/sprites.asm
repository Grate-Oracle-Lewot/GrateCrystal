...
LewotSpriteGFX::               INCBIN "gfx/sprites/lewot.2bpp"
PercySpriteGFX::               INCBIN "gfx/sprites/percy.2bpp"
...
GlitchSpriteGFX::              INCBIN "gfx/sprites/missingno.2bpp"
CookSpriteGFX::                INCBIN "gfx/sprites/cook.2bpp"
SittingBirdSpriteGFX::         INCBIN "gfx/sprites/sitting_bird.2bpp"
MonsterBackSpriteGFX::         INCBIN "gfx/sprites/monster_back.2bpp"
ClefairyDollSpriteGFX::        INCBIN "gfx/sprites/clefairy_doll.2bpp"
JigglypuffDollSpriteGFX::      INCBIN "gfx/sprites/jigglypuff_doll.2bpp"
ShellderDollSpriteGFX::        INCBIN "gfx/sprites/shellder_doll.2bpp"
TentacoolDollSpriteGFX::       INCBIN "gfx/sprites/tentacool_doll.2bpp"
BulbasaurDollSpriteGFX::       INCBIN "gfx/sprites/bulbasaur_doll.2bpp"
SquirtleDollSpriteGFX::        INCBIN "gfx/sprites/squirtle_doll.2bpp"
DiglettDollSpriteGFX::         INCBIN "gfx/sprites/diglett_doll.2bpp"
OddishDollSpriteGFX::          INCBIN "gfx/sprites/oddish_doll.2bpp"
GrimerDollSpriteGFX::          INCBIN "gfx/sprites/grimer_doll.2bpp"
GeodudeDollSpriteGFX::         INCBIN "gfx/sprites/geodude_doll.2bpp"
MachopDollSpriteGFX::          INCBIN "gfx/sprites/machop_doll.2bpp"
MarySpriteGFX::                INCBIN "gfx/sprites/mary.2bpp"
LotusLadySpriteGFX::           INCBIN "gfx/sprites/lotus_lady.2bpp"
YellowPikachuSpriteGFX::       INCBIN "gfx/sprites/yellow_pikachu.2bpp"
EusineSpriteGFX::              INCBIN "gfx/sprites/eusine.2bpp"
ADSpriteGFX::                  INCBIN "gfx/sprites/a_d.2bpp"
