...
FlogistanAnimation:  INCLUDE "gfx/pokemon/flogistan/anim.asm"
...
SnoconeyAnimation:   INCLUDE "gfx/pokemon/snoconey/anim.asm"
JirkAnimation:       INCLUDE "gfx/pokemon/jirk/anim.asm"
CastaweighAnimation: INCLUDE "gfx/pokemon/castaweigh/anim.asm"
