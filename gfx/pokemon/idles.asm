...
FlogistanAnimationIdle:  INCLUDE "gfx/pokemon/flogistan/anim_idle.asm"
...
SnoconeyAnimationIdle:   INCLUDE "gfx/pokemon/snoconey/anim_idle.asm"
JirkAnimationIdle:       INCLUDE "gfx/pokemon/jirk/anim_idle.asm"
CastaweighAnimationIdle: INCLUDE "gfx/pokemon/castaweigh/anim_idle.asm"
