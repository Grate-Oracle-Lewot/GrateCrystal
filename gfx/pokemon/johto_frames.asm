...
FlogistanFrames:  INCLUDE "gfx/pokemon/flogistan/frames.asm"
...
SnoconeyFrames:   INCLUDE "gfx/pokemon/snoconey/frames.asm"
JirkFrames:       INCLUDE "gfx/pokemon/jirk/frames.asm"
CastaweighFrames: INCLUDE "gfx/pokemon/castaweigh/frames.asm"
