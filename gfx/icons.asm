...
FleaIcon:         INCBIN "gfx/icons/flea.2bpp"
SpiralIcon:       INCBIN "gfx/icons/spiral.2bpp"
...
PikachuDollIcon:    INCBIN "gfx/icons/pikachu_doll.2bpp"
ClefairyDollIcon:   INCBIN "gfx/icons/clefairy_doll.2bpp"
JigglypuffDollIcon: INCBIN "gfx/icons/jigglypuff_doll.2bpp"
ShellderDollIcon:   INCBIN "gfx/icons/shell_doll.2bpp"
TentacoolDollIcon:  INCBIN "gfx/icons/tentacool_doll.2bpp"
