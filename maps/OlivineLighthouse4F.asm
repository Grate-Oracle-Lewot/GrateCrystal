...
LassConnieAfterBattleText:
	text "None of this would"
	line "have happened if"
	cont "STEVEN were here…"
	done
...
OlivineLighthouse4F_MapEvents:
	...
	object_event 11,  2, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerLassConnie, -1
