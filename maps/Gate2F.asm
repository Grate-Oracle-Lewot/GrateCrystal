...
Gate2F_MapEvents:
	...
	object_event  4,  4, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FBugCatcherScript, EVENT_GATE_2F_BUG_CATCHER
	object_event  3,  4, SPRITE_TWIN, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FTwinScript, EVENT_GATE_2F_TWIN
	object_event  5,  4, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FYoungsterScript, EVENT_GATE_2F_YOUNGSTER
	object_event  2,  4, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FCooltrainerFScript, EVENT_GATE_2F_COOLTRAINER_F
	object_event  6,  4, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FCooltrainerMScript, EVENT_GATE_2F_COOLTRAINER_M
	object_event  1,  4, SPRITE_LASS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FLassScript, EVENT_GATE_2F_LASS
	object_event  4,  5, SPRITE_FISHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FFisherScript, EVENT_GATE_2F_FISHER
	object_event  3,  5, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FTeacherScript, EVENT_GATE_2F_TEACHER
	object_event  5,  5, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FPokefanMScript, EVENT_GATE_2F_POKEFAN_M
	object_event  2,  5, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FPokefanFScript, EVENT_GATE_2F_POKEFAN_F
	object_event  4,  6, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FGrampsScript, EVENT_GATE_2F_GRAMPS
	object_event  3,  6, SPRITE_GRANNY, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FGrannyScript, EVENT_GATE_2F_GRANNY
	object_event  4,  3, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FGentlemanScript, EVENT_GATE_2F_GENTLEMAN
	object_event  3,  3, SPRITE_SAGE, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Gate2FSageScript, EVENT_GATE_2F_SAGE
