...
IcePathArticunoChamber_MapEvents:
	...
	object_event  9,  7, SPRITE_BIRD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_OW_BLUE, OBJECTTYPE_SCRIPT, 0, IcePathArticunoChamberArticunoScript, EVENT_ICE_PATH_ARTICUNO_CHAMBER_ARTICUNO
