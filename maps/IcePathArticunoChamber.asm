...
IcePathArticunoChamber_MapEvents:
	...
	object_event 15,  1, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_PINK, OBJECTTYPE_SCRIPT, 0, IcePathArticunoChamberSlowkingScript, EVENT_ICE_PATH_ARTICUNO_CHAMBER_ARTICUNO
