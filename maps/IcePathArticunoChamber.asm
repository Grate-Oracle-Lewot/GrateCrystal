...
IcePathArticunoChamber_MapEvents:
	...
	object_event  9,  7, SPRITE_BIRD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, IcePathArticunoChamberArticunoScript, EVENT_ICE_PATH_ARTICUNO_CHAMBER_ARTICUNO
