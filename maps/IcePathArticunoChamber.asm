...
IcePathArticunoChamber_MapEvents:
	...
	object_event 15,  1, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IcePathArticunoChamberSlowkingScript, EVENT_ICE_PATH_ARTICUNO_CHAMBER_SLOWKING
