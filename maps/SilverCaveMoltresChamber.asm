...
SilverCaveMoltresChamber_MapEvents:
	...
	object_event 10, 23, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_PINK, OBJECTTYPE_SCRIPT, 0, SilverCaveMoltresChamberSlowkingScript, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_MOLTRES
