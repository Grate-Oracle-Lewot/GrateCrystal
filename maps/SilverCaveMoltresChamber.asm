...
SilverCaveMoltresChamber_MapEvents:
	...
	def_warp_events
	warp_event 12, 39, SILVER_CAVE_ITEM_ROOMS, 3
	warp_event 13, 39, SILVER_CAVE_ITEM_ROOMS, 3
	...
	def_object_events
	object_event 19,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_ITEMBALL, 0, SilverCaveMoltresChamberSacredAsh, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_SACRED_ASH
	object_event 12, 27, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, SilverCaveMoltresChamberSlowkingScript, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_MOLTRES
	object_event  9, 11, SPRITE_BIRD, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveMoltresChamberMoltresScript, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_MOLTRES
