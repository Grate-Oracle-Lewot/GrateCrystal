...
SilverCaveMoltresChamber_MapEvents:
	...
	def_object_events
	object_event 17,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_SILVER, OBJECTTYPE_ITEMBALL, 0, SilverCaveMoltresChamberSacredAsh, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_SACRED_ASH
	object_event 10, 23, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_PINK, OBJECTTYPE_SCRIPT, 0, SilverCaveMoltresChamberSlowkingScript, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_SLOWKING
	object_event  7,  7, SPRITE_BIRD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveMoltresChamberMoltresScript, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_MOLTRES
