...
SilverCaveMoltresChamber_MapEvents:
	...
	object_event  7,  7, SPRITE_BIRD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_OW_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveMoltresChamberMoltresScript, EVENT_SILVER_CAVE_MOLTRES_CHAMBER_MOLTRES
