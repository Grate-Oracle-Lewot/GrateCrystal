...
RuinsOfAlphResearchCenter_MapEvents:
	...
	object_event  0,  0, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphResearchCenterMoveTutorScript, EVENT_AURA_SPHERE_MOVE_TUTOR
