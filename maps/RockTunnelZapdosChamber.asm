...
RockTunnelZapdosChamber_MapEvents:
	...
	object_event 15,  3, SPRITE_BIRD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RockTunnelZapdosChamberZapdosScript, EVENT_ROCK_TUNNEL_ZAPDOS_CHAMBER_ZAPDOS
