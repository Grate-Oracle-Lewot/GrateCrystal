...
RockTunnelZapdosChamber_MapEvents:
	...
	object_event 16, 12, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RockTunnelZapdosChamberSlowkingScript, EVENT_ROCK_TUNNEL_ZAPDOS_CHAMBER_SLOWKING
