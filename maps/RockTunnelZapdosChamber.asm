...
RockTunnelZapdosChamber_MapEvents:
	...
	object_event 16, 12, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_PINK, OBJECTTYPE_SCRIPT, 0, RockTunnelZapdosChamberSlowkingScript, EVENT_ROCK_TUNNEL_ZAPDOS_CHAMBER_SLOWKING
	object_event 15,  3, SPRITE_BIRD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RockTunnelZapdosChamberZapdosScript, EVENT_ROCK_TUNNEL_ZAPDOS_CHAMBER_ZAPDOS
