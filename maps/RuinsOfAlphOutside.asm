...
SuperNerdStanAfterBattleText:
	...
	para "#MON found here"
	line "are also seen in"

	para "places where leg-"
	line "endary #MON can"
	cont "be glimpsed…"
	done
...
RuinsOfAlphOutside_MapEvents:
	...
	warp_event 10, 13, RUINS_OF_ALPH_ANTECHAMBER, 1
	...
	def_object_events
	object_event  4, 20, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, -1
	object_event 11, 15, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideScientistScript, EVENT_RUINS_OF_ALPH_OUTSIDE_SCIENTIST
	...
	object_event 12, 31, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 1, TrainerSuperNerdStan, -1
