	object_const_def
	const CELADONMANSION1F_LOTUS_LADY
...
CeladonMansion1F_MapEvents:
	...
	def_object_events
	object_event  1,  5, SPRITE_LOTUS_LADY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonMansionManager, -1
	object_event  2,  6, SPRITE_GROWLITHE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CeladonMansion1FMeowth, -1
