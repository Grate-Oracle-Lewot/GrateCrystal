...
MewAntechamber_MapEvents:
	...
	object_event  9,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_BLUE, OBJECTTYPE_ITEMBALL, 0, MewAntechamberTMDarkPulse, EVENT_MEW_ANTECHAMBER_TM_DARK_PULSE
