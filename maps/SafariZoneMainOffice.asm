...
SafariZoneMainOffice_MapEvents:
	...
	object_event  0,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneMainOfficeLeek, EVENT_SAFARI_ZONE_MAIN_OFFICE_LEEK
