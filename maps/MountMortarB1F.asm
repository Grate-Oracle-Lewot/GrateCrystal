...
MountMortarB1F_MapEvents:
	...
	object_event 11,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FSwagBeacon, EVENT_MOUNT_MORTAR_B1F_SWAG_BEACON
