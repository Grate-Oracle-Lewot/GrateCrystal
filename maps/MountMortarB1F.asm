...
.BeatKiyo:
	...
	ifless PARTY_LENGTH, .GetTyrogue
...
MountMortarB1F_MapEvents:
	...
	def_object_events
	object_event 16,  4, SPRITE_BLACK_BELT, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, MountMortarB1FKiyoScript, -1
	...
	object_event 11,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FPearl, EVENT_MOUNT_MORTAR_B1F_PEARL
