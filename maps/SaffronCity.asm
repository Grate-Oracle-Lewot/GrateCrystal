...
SaffronCity_MapEvents:
	...
	warp_event 35, 11, SAFFRON_MART, 2
	warp_event 19, 29, SAFFRON_POKECENTER_1F, 1
	warp_event 37, 29, MR_PSYCHICS_HOUSE, 1
	warp_event 18,  3, SAFFRON_MAGNET_TRAIN_STATION, 2
	warp_event 28, 21, SILPH_CO_1F, 1
	warp_event 19, 11, COPYCATS_HOUSE_1F, 1
	warp_event 28,  3, ROUTE_5_SAFFRON_GATE, 3
	warp_event 10, 24, ROUTE_7_SAFFRON_GATE, 3
	warp_event 10, 25, ROUTE_7_SAFFRON_GATE, 4
	warp_event 26, 33, ROUTE_6_SAFFRON_GATE, 1
	warp_event 27, 33, ROUTE_6_SAFFRON_GATE, 2
	warp_event 49, 22, ROUTE_8_SAFFRON_GATE, 1
	warp_event 49, 23, ROUTE_8_SAFFRON_GATE, 2

	def_coord_events

	def_bg_events
	bg_event 31,  5, BGEVENT_READ, SaffronCitySign
	bg_event 43,  5, BGEVENT_READ, SaffronGymSign
	bg_event 35,  5, BGEVENT_READ, FightingDojoSign
	bg_event 25, 21, BGEVENT_READ, SilphCoSign
	bg_event 35, 29, BGEVENT_READ, MrPsychicsHouseSign
	bg_event 21,  5, BGEVENT_READ, SaffronCityMagnetTrainStationSign
	bg_event 20, 29, BGEVENT_READ, SaffronCityPokecenterSign
	bg_event 36, 11, BGEVENT_READ, SaffronCityMartSign

	def_object_events
	object_event 17, 14, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaffronCityLass1Script, -1
	object_event 29, 30, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SaffronCityPokefanMScript, -1
	object_event 42,  7, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityCooltrainerMScript, -1
	object_event 30, 24, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaffronCityCooltrainerFScript, -1
	object_event 37, 12, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityFisherScript, -1
	object_event 25, 19, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SaffronCityYoungster1Script, -1
	object_event 45, 22, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaffronCityYoungster2Script, -1
	object_event 29,  8, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityLass2Script, -1
	object_event 44,  4, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SaffronCityBugCatcherScript, EVENT_SABRINA_IN_FIGHTING_DOJO
	object_event 38, 12, SPRITE_YELLOW_PIKACHU, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SaffronCityYellowPikachuScript, -1
