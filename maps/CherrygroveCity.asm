...
CherrygroveCity_MapEvents:
	...
	warp_event 25,  9, VIRIDIAN_POKECENTER_1F, 1
	...
	object_event 27, 12, SPRITE_BEAUTY, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CherrygroveTeacherScript, -1
