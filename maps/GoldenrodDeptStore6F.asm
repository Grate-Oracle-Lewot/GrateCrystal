GOLDENRODDEPTSTORE6F_SPRING_WATER_PRICE EQU 200
...
.SpringWater:
	checkmoney YOUR_MONEY, GOLDENRODDEPTSTORE6F_SPRING_WATER_PRICE
	ifequal HAVE_LESS, .NotEnoughMoney
	giveitem SPRING_WATER
	iffalse .NotEnoughSpace
	takemoney YOUR_MONEY, GOLDENRODDEPTSTORE6F_SPRING_WATER_PRICE
...
.MenuData:
	...
	db 4 ; items
	db "SPRING WATER ¥{d:GOLDENRODDEPTSTORE6F_SPRING_WATER_PRICE}@"
