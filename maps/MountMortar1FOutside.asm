...
MountMortar1FOutsideHiddenDuskBall:
...
MountMortar1FOutside_MapEvents:
	...
	bg_event 36, 29, BGEVENT_ITEM, MountMortar1FOutsideHiddenDuskBall
	...
	object_event 31,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_OW_BLUE, OBJECTTYPE_ITEMBALL, 0, MountMortar1FOutsideTMScald, EVENT_MOUNT_MORTAR_1F_OUTSIDE_TM_SCALD
