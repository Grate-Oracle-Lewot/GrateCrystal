...
WhirlIsland1F_MapEvents:
	...
	warp_event  3, 15, WHIRL_ISLAND_SW, 11   ;  3 ; NW 3
	warp_event  7, 15, WHIRL_ISLAND_CAVE, 16 ;  4 ; NW 4
	...
	warp_event  3, 35, WHIRL_ISLAND_NW, 3    ; 11 ; SW 4
	...
	warp_event  3, 53, WHIRL_ISLAND_NW, 4    ; 16 ; CAVE 2
