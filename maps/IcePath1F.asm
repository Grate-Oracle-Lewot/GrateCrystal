...
IcePath1F_MapEvents:
	...
	object_event 15, 13, SPRITE_DRAGONITE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IcePath1FDragoniteScript, EVENT_MAHOGANY_TOWN_POKEFAN_M_BLOCKS_EAST
