	...
	const UNIONCAVESLOWPOKEWELLLINK_ROCKER
...
UnionCaveSlowpokeWellLink_MapEvents:
	...
	object_event 34, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, UnionCaveSlowpokeWellLinkPickaxe, EVENT_UNION_CAVE_SLOWPOKE_WELL_LINK_PICKAXE
