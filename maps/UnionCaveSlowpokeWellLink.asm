	...
	const UNIONCAVESLOWPOKEWELLLINK_ROCK
...
UnionCaveSlowpokeWellLink_MapEvents:
	...
	object_event 34, 11, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, UnionCaveSlowpokeWellLinkRock, -1
