...
NewBarkTownSign:
	winlosstext NewBarkTownRivalText1, NewBarkTownRivalText2
...
NewBarkTown_MapEvents:
	...
	warp_event 11, 13, GOLDENROD_CITY, 1
	...
	def_object_events
	object_event  6,  8, SPRITE_BEAUTY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownTeacherScript, -1
