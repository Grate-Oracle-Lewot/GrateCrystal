	...
	const POKECENTER2F_TRADEBACK_GUY
...
Pokecenter2F_MapEvents:
	...
	object_event  6,  6, SPRITE_DAISY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Pokecenter2FNayruScript, EVENT_POKECENTER_2F_NAYRU
