...
OaksLab2F_MapEvents:
	...
	object_event 21, 11, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, OaksLab2FCooltrainerMBlakeScript, EVENT_OAKS_LAB_2F_COOLTRAINERM_BLAKE
