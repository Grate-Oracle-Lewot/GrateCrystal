...
Route22House_MapEvents:
	...
	object_event  7,  6, SPRITE_GLITCH, SPRITEMOVEDATA_STILL, 0, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route22HouseMissingnoScript, EVENT_ROUTE_22_HOUSE_MISSINGNO
	object_event  7,  2, SPRITE_ELDER, SPRITEMOVEDATA_STANDING_LEFT, 0, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route22HouseMrFujiScript, EVENT_ROUTE_22_HOUSE_MR_FUJI
