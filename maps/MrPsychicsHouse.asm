...
MrPsychic:
	...
	promptbutton
	verbosegiveitem TM_PSYCHIC_M, 5
	iffalse .Done
...
MrPsychicsHouse_MapEvents:
	...
	def_object_events
	object_event  5,  3, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, MrPsychic, -1
