...
.HoOh:
	...
	writetext EusineRainbowWingText
	waitbutton
	closetext
	readvar VAR_FACING
...
EusineRainbowWingText:
	text "I found it at the"
	line "TIN TOWER after"

	para "you battled SUI-"
	line "CUNE. It looks"

	para "like it came from"
	line "HO-OH. It might"
	cont "come in handy!"
...
CeladonPokecenter1F_MapEvents:
	...
	def_object_events
	object_event  3,  1, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonPokecenter1FNurseScript, -1
	object_event  4,  1, SPRITE_CHANSEY, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, CeladonPokecenter1FChanseyScript, -1
	...
	object_event  4,  3, SPRITE_EUISINE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeladonEusine, EVENT_SET_WHEN_FOUGHT_HO_OH
