...
TeamRocketBaseB3F_MapScripts:
	...
	scene_script .DummyScene ; SCENE_TEAMROCKETBASEB3F_RIVAL_ENCOUNTER
	scene_script .DummyScene ; SCENE_TEAMROCKETBASEB3F_ROCKET_BOSS
	scene_script .DummyScene ; SCENE_TEAMROCKETBASEB3F_NOTHING
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  8,  3, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B3F_EXECUTIVE
	object_event  7,  2, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, RocketBaseMurkrow, EVENT_TEAM_ROCKET_BASE_POPULATION
