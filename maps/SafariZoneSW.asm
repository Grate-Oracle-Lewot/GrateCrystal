...
SafariZoneSW_MapEvents:
	...
	object_event  9, 18, SPRITE_MR_MIME, SPRITEMOVEDATA_POKEMON, 0, 0, NOON_HOUR, MAX_HOUR, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, SafariZoneSWMrMimeScript, EVENT_SAFARI_ZONE_SW_MR_MIME
