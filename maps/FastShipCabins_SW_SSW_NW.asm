...
FastShipCabins_SW_SSW_NW_MapEvents:
	...
	object_event  6, 15, SPRITE_FISHING_GURU, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBugCatcherKen, EVENT_FAST_SHIP_PASSENGERS_WESTBOUND
