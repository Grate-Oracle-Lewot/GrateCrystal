	...
	const SLOWPOKEWELLB2F_POKE_BALL3
...
SlowpokeWellB2F_MapEvents:
	...
	object_event  8, 31, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SlowpokeWellB2FLeftovers, EVENT_SLOWPOKE_WELL_B2F_LEFTOVERS
	object_event 14, 34, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SlowpokeWellB2FQuickClaw, EVENT_SLOWPOKE_WELL_B2F_QUICK_CLAW
