...
LavRadioTower2F_MapEvents:
	...
	object_event 10,  8, SPRITE_MONSTER, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, LavRadioTower2FMewtwoScript, EVENT_LAV_RADIO_TOWER_2F_MEWTWO
