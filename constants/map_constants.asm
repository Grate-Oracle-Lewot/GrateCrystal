...
; - scripts and events (see data/maps/scripts.asm)
	...
	newgroup SAFARI                                         ; group  4
	map_const SAFARI_ZONE,                                 30, 27 ;  1
	endgroup

	newgroup FAST_SHIP                                      ; group  5
