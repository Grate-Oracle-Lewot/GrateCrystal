...
; - scripts and events (see data/maps/scripts.asm)
	...
	newgroup SAFARI                                         ; group  9
	map_const SAFARI_ZONE,                                 30, 27 ;  1
	endgroup

	newgroup SAFFRON                                        ; group 10
	...
	newgroup LAKE_OF_RAGE                                   ; group 23
