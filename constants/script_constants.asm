...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_ROUTE_46_1    ; 15
	const FRUITTREE_ROUTE_46_2    ; 16
	const FRUITTREE_ROUTE_26      ; 17
	const FRUITTREE_ROUTE_1       ; 18
	const FRUITTREE_ROUTE_2       ; 19
	const FRUITTREE_PEWTER_CITY_1 ; 1a
	const FRUITTREE_PEWTER_CITY_2 ; 1b
	const FRUITTREE_ROUTE_8       ; 1c
	const FRUITTREE_ROUTE_11      ; 1d
