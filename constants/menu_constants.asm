...
; PartyMenuQualityPointers indexes (see data/party_menu_qualities.asm)
	const_def
	const PARTYMENUACTION_CHOOSE_POKEMON ;  0
	const PARTYMENUACTION_HEALING_ITEM   ;  1
	const PARTYMENUACTION_SWITCH         ;  2
	const PARTYMENUACTION_TEACH_TMHM     ;  3
	const PARTYMENUACTION_MOVE           ;  4
	const PARTYMENUACTION_EVO_STONE      ;  5
	const PARTYMENUACTION_GIVE_MON       ;  6
	const PARTYMENUACTION_GIVE_ITEM      ;  7
	const PARTYMENUACTION_MOBILE         ;  8
