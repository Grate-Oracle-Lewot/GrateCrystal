...
; held item effects
	...
	const HELD_BONE
	const HELD_VOLTECCER
	const HELD_WEATHER_BOOST
	const HELD_SUN_STONE

; leftovers types
SLOWHEAL_LEFTOVERS    EQU 0
SLOWHEAL_SLOWPOKETAIL EQU 1
SLOWHEAL_CANDIED_YAM  EQU 42
