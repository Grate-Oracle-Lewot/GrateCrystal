...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_TIN_TOWER
...
; wGameTimerPaused
	const ENGINE_GAME_TIMER_PAUSED
; wPlayerGender
...
; wDailyRematchFlags
	...
	const ENGINE_DEREK_READY_FOR_REMATCH
...
; wDailyPhoneTimeOfDayFlags
	...
	const ENGINE_JOSE_SATURDAY_AFTERNOON
	...
	const ENGINE_BRENT_MONDAY_NIGHT
	...
	const ENGINE_DEREK_SATURDAY_MORNING
	const ENGINE_IRWIN_SUNDAY_NIGHT
