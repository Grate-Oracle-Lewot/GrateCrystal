...
TM01 EQU const_value
	...
	add_tm NIGHTMARE    ; f0
	add_tm FAIRY_WIND   ; f1
	add_tm MOONBLAST    ; f2
	add_tm DARK_PULSE   ; f3
	add_tm HAIL         ; f4
	add_tm NIGHT_TERROR ; f5
	add_tm SUBSTITUTE   ; f6
