...
; Beauty
	...
	const EVENT_BEAT_SWIMMER_F_JACLYN
	const EVENT_BEAT_BEAUTY_BRENDA
	const EVENT_BEAT_BEAUTY_CASSIE
	const EVENT_BEAT_POKEFAN_F_CAROLINE
...
; New to Grate Crystal
	...
	const EVENT_SAFARI_ZONE_SUNFLORA
...
; New to Grate Crystal
	...
	const EVENT_SAFARI_ZONE_BONE
	const EVENT_SAFARI_ZONE_CALCIUM
