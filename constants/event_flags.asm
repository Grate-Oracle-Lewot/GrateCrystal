...
; New to Grate Crystal
	...
	const EVENT_SEAFOAM_CAVE_B1F_HIDDEN_BERRY_JUICE
...
; New to Grate Crystal
	...
	const EVENT_SEAFOAM_CAVE_B1F_FERALIGATR
	const EVENT_SEAFOAM_CAVE_B1F_OAK
	const EVENT_SEAFOAM_CAVE_B1F_PSN_OAK
	...
	const EVENT_SILPH_CO_2F_EVIOLITE
