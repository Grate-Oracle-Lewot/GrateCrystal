...
TREEMON_SLEEP_TURNS EQU 5

; default move priority
BASE_PRIORITY EQU 1

; type effectiveness factors, scaled by 10
EXTREMELY_EFFECTIVE   EQU 40
SUPER_DUPER_EFFECTIVE EQU 30
SUPER_EFFECTIVE       EQU 20
MORE_EFFECTIVE        EQU 15
TRI_ATTACK_SUN        EQU 11
EFFECTIVE             EQU 10
TRI_ATTACK_RAIN       EQU 09
...
FUTURE_SIGHT_BASE_POWER EQU 100
