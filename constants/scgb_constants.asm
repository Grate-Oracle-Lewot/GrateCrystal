...
; SGBLayoutJumptable indexes (see engine/gfx/sgb_layouts.asm)
	...
	const SCGB_STATS_SCREEN_HIDDEN_PAL
	const SCGB_POKEDEX
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_BETA_INTRO_VENUSAUR ; dex lime
	...
	const PREDEFPAL_BETA_RADIO ; dex white
	const PREDEFPAL_BETA_POKEGEAR ; dex orange
	const PREDEFPAL_47 ; dex purple 
