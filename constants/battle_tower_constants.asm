...
BATTLE_TOWER_STRUCT_LENGTH EQU NAME_LENGTH + BATTLETOWER_PARTY_LENGTH * PARTYMON_STRUCT_LENGTH + BATTLETOWER_TRAINERDATALENGTH ; not $e0
BATTLE_TOWER_DUMMY_STRUCT_LENGTH EQU NAME_LENGTH + BATTLETOWER_PARTY_LENGTH * NICKNAMED_MON_STRUCT_LENGTH + BATTLETOWER_TRAINERDATALENGTH ; $e0
